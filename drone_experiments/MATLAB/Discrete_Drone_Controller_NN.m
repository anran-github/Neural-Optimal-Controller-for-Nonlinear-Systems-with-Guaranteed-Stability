%!!!
% DISCRETE TIME IS NOT AVAILABLE AT MOMENT, USING CONTINUES-TIME CONTROL INSTEAD!
...
%% LOAD NN MODELS
% Load ONNX model--X
netx = importNetworkFromONNX("weights/NN_x.onnx");
...
% Load ONNX model--Y
nety = importNetworkFromONNX("weights/NN_y.onnx");
% model = importONNXNetwork('model.onnx');
...
% Load ONNX model--X
netz = importNetworkFromONNX("weights/NN_z.onnx");
% model = importONNXNetwork('model.onnx');
