...
global deltaT drone_mode Cont GoalPt DESIRED1 Kx Ky Kz x_r x_init INIT_POS_ADJUST Ky_init Kx_init Kz_init
...
[Kx_init,Sx,CLP]=dlqr(Axd,Bxd,Q_init,R);
[Ky_init,Sy,CLP]=dlqr(Ayd,Byd,Q_init,R);
[Kz_init,Sz,CLP]=dlqr(Azd,Bzd,Qz_init,R);
...
if INIT_POS_ADJUST < 200
    % adjust init position
    ux = -Kx_init*(x-x_init(:,1));
    uy = -Ky_init*(y-x_init(:,2));
    uz = -Kz_init*(z-x_init(:,3));
    % uz=0;
